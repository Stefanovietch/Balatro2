...
public class Balatro : PlaceholderCharacterModel
{
    ...
    public static readonly SavedSpireField<Player, bool> GrosMichelExtinct =
        new(() => false, "balatro_gros_michel_extinct");
    ...
    {
        var visual =
            NodeFactory<NCreatureVisuals>.CreateFromResource($"decks/{BalatroConfig.SelectedDeck}.png".ImagePath());
        return visual;
    }
}