...
public class TheTribe() : BalatroCard(1,
    ...
    TargetType.AnyEnemy)
{
    ...
    {
        if (cardSource == this && HasOnlyAttack()) return 2;
        return base.ModifyDamageMultiplicative(target, amount, props, dealer, cardSource);
    }

    protected override bool ShouldGlowGoldInternal => HasOnlyAttack();

    private bool HasOnlyAttack()
    {
